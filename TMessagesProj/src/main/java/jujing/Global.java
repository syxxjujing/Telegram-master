...
public class Global {
    public static final String XPOSED_CODE = "59";//TODO 测试  记得改isDebug！！！
    ...
    public static boolean IS_DEBUG_XIAOMI = true;//TODO 测试
    public static boolean IS_DEBUG_LOGIN = false;//TODO 测试



    public static final String storage = Environment.getExternalStorageDirectory().getAbsolutePath() + "/1tele";
